...
tittle() {
    ...
    clear && clear
    msg -bar
    cat <(curl -sSL https://raw.githubusercontent.com/donpato01/kk/main/.banner)
    msg -bar
}
in_opcion() {
    unset opcion
...
fun_filez() {
    ...
    wget -O /bin/http-server.sh https://raw.githubusercontent.com/donpato01/culichiadm/main/http-server.py  && chmod +x /bin/http-server.sh
...
DOWS() {
    wget -O /root/lista https://raw.githubusercontent.com/donpato01/kk/main/lista
...
atualiza_fun() {
    ...
    wget -q -O /usr/bin/gerar https://raw.githubusercontent.com/donpato01/culichiadm/main/kakamod && chmod +rwx /usr/bin/gerar
    cd $HOME
    msg -bar
...
check_ip
atualiza_fun
wget -O /etc/admdb https://raw.githubusercontent.com/donpato01/culichiadm/main/mokaka.zip
;;
--update)atualiza_fun;;
--bot)atualiza_fun;;
-xd)
cp /etc/admdb /etc/ADM-db/xd
tar xpf /etc/ADM-db/xd

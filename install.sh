...
msg -bar
echo -e ""
echo -e "${cor[2]}\n\033[1;37m  Script Patrocinado por: @drowkid01 | VModKid1.2" | pv -qL 12
echo -e ""
msg -bar
echo -e "  ${cor[5]} VModKid1.2 REFACTORIZADO " 
msg -bar
...
# Creado por @ChumoGH
SCPdir="/etc/adm-lite"
cd ${SCPdir} && ./menu' > /bin/drowk && chmod +x /bin/drowk
echo '#!/bin/bash
# Creado por @ChumoGH
SCPdir="/etc/adm-lite"
...
msg -bar3 
echo -e "    ${FlT}${rUlq} ADMcgh[dk] | MOD @drowkid01  ${rUlq}${FlT}  -" | lolcat
msg -bar3
